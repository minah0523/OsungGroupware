...
<script type="text/javascript">
	...
	$("select#approvalSort").bind("change", function() {
		...
		if ($(this).val()==1) {
			docSortTitle += "일반품의서";
			html +="<input type='hidden' name='contents2' value='none' />"+
				   "<input type='hidden' name='contents3' value='none' />"+
				   "<input type='hidden' name='contents4' value='none' />";
			...
			"						<span  " + 
			"						style='font-family: &amp; amp; quot; malgun gothic&amp;amp; quot; , dotum , arial, tahoma; font-size: 9pt;'><input type='text' name='contents2' style='width: 99%;'/></span>  " + 
			"					</td>  " + 
			"					<td  " + 
			"						style='padding: 3px; height: 20px; vertical-align: middle; border: 1px solid black; text-align: center; font-weight: bold;'>  " + 
			"						총 비 용</td>  " + 
			...
			"						style='padding: 3px; height: 20px; vertical-align: middle; border: 1px solid black; text-align: left;'>  " + 
			"						<span  " + 
			"						style='font-family: &amp; amp; quot; malgun gothic&amp;amp; quot; , dotum , arial, tahoma; font-size: 9pt;'><input type='text' name='contents3' style='width: 90%;' />  원</span>  " + 
			"					</td>  " + 
			"					<td  " + 
			"						style='padding: 3px; height: 20px; vertical-align: middle; border: 1px solid black; text-align: center; font-weight: bold;'>  " + 
			"						비용처리방법</td>  " + 
			...
			"						style='padding: 3px; height: 20px; vertical-align: middle; border: 1px solid black; text-align: left;'>  " + 
			"						<span  " + 
			"						style='font-family: &amp; amp; quot; malgun gothic&amp;amp; quot; , dotum , arial, tahoma; font-size: 9pt;'><input type='text' name='contents3' style='width: 90%;' /></span>  " + 
			"					</td>  " + 
			"					<td  " + 
			"						style='padding: 3px; height: 20px; vertical-align: middle; border: 1px solid black; text-align: center; font-weight: bold;'>  " + 
			"						제 출 처</td>  " + 
    ...
    */    
		...
		frm.method = "POST";
		frm.action = "<%= ctxPath%>/elecapproval/writeEnd.os";
		frm.submit();   
    }); 
				...
				<tr class="tblElecApprInfo">
					...
					<td class="tblElecApprInfo" style="align-items: center;">
						<div class="box" style="width: 93%; align-items: center;">
							<select name="fk_approval_sort_no" id="approvalSort" class="form-control pull-right row b-none"
