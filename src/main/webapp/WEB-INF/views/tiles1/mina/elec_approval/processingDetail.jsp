...
$(document).ready(function(){
		...
		$("button#btnDelete").click(function(){
			...
			frm.method = "POST";
			frm.action = "<%=ctxPath%>/elecapproval/delProcessing.os";
			frm.submit();
		});
...
<div id="titleInBox" style="font-weight: bold; font-size: 19px;">진행중문서 상세보기</div>
	<form name="delFrm">
	<div id="containerBox">
	...
	<input type="hidden" name="approval_no" value="${elecapprvo.approval_no}"/>
  	<p id="submitArea" >
		<button id="btnDelete" class="btn btn-danger m-l-20 btn-rounded btn-outline hidden-xs hidden-sm waves-effect waves-light" style="width: 130px">상신취소(삭제)</button>
