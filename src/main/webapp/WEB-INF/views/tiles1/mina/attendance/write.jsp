...
<script type="text/javascript">
	...
	$("select#attendanceSort").bind("change", function() {
		...
		if ($(this).val()==1) {
			...
			"    																																<option value='오후'>오후</option></select></span>"+
			"					</td>  " + 
			"					<td  " + 
			"						style='padding: 3px; height: 20px; vertical-align: middle; border: 1px solid black; text-align: center; font-weight: bold;'>  " + 
			"						사    유</td>  " + 
			...
			"						<span  " + 
			"						style='font-family: &amp; amp; quot; malgun gothic&amp;amp; quot; , dotum , arial, tahoma; font-size: 9pt;'><input type='text' name='vacation_days' style='width: 80%;' /> &nbsp;&nbsp;&nbsp; 개</span>  " + 
			"					</td>  " + 
			"					  " + 
			"				</tr>  " + 
			"			</tbody>  " + 
...
<div id="titleInBox" style="font-weight: bold; font-size: 19px;">연차 신청 진행</div>
<div id="containerBox">
		...
		<div class="divElecApprInfo table-responsive"
			...
			<table class="table table-bordered tblElecApprInfo"
				...
				<tr class="tblElecApprInfo">
					<th class="tblElecApprInfo">근태종류</th>
				...
				<tbody>
					<tr>
						<td
							...
							colspan='2'><span id="docSortTitle">근태종류</span></td>
						<td
