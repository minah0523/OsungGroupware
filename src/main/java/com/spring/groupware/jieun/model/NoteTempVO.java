...
public class NoteTempVO { // 임시보관함

	private String note_no;					// 편지번호
	...
	private String note_reservation_date;   // 예약 설정 시간(null허용)
	...
	public NoteTempVO(String note_no, int fk_emp_no_send, int fk_emp_no_receive, String fk_emp_name, String note_title,
			...
			String note_reservation_date, String emp_name, String dept_name_send, String dept_name_receive, MultipartFile attach) {
		super();
	...
	public int getNote_send_del_status() {
		return note_send_del_status;
	}

	public void setNote_send_del_status(int note_send_del_status) {
		this.note_send_del_status = note_send_del_status;
	}

	public int getNote_receive_del_status() {
		return note_receive_del_status;
	}
