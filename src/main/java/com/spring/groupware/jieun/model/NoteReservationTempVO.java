...
public class NoteReservationTempVO { // 쪽지함
    ...
    */
	...
	public NoteReservationTempVO() {}
	
	public NoteReservationTempVO(String note_no, int fk_emp_no_send, int fk_emp_no_receive, String fk_emp_name, String note_title,
