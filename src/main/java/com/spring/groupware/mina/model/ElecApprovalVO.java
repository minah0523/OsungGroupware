...
public class ElecApprovalVO {
	
	private	int		approval_no;          
	private	int		fk_approval_sort_no;
    ...
    */
	...
	//기본생성자
	public ElecApprovalVO() {}


	public ElecApprovalVO(int approval_no, int fk_approval_sort_no, int fk_emp_no, int emergency,
			String fk_mid_approver_no, String fk_fin_approver_no, String title, String content, String contents2,
			String contents3, String contents4, String server_file_name, String org_file_name, String file_path,
			int mid_approval_ok, int fin_approval_ok, int approval_status, String mid_approval_opinion,
			String fin_approval_opinion, String writeday, String emp_name, EmployeeVO empvo, EmployeeVO midapprvo,
			EmployeeVO finapprvo) {
		super();
		this.approval_no = approval_no;
		this.fk_approval_sort_no = fk_approval_sort_no;
	...
	public int getFk_approval_sort_no() {
		return fk_approval_sort_no;
	}


	public void setFk_approval_sort_no(int fk_approval_sort_no) {
		this.fk_approval_sort_no = fk_approval_sort_no;
	}
